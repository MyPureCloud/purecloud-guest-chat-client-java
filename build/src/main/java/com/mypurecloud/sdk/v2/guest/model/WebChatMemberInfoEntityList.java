...
public class WebChatMemberInfoEntityList  implements Serializable, PagedResource<WebChatMemberInfo> {
  ...
  /**
   **/
  public WebChatMemberInfoEntityList entities(List<WebChatMemberInfo> entities) {
  ...
  public List<WebChatMemberInfo> getEntities() {
    return entities;
  }
  public void setEntities(List<WebChatMemberInfo> entities) {
    this.entities = entities;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entities, pageSize, pageNumber, total, firstUri, nextUri, lastUri, previousUri, selfUri, pageCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebChatMemberInfoEntityList {\n");
